...
" Case.csv  / Case.xlsx"  :- This is our dataset on which the code is operating upon.

" Solution.py "  :- This is our Solution code in python(v3.7) , if u want to run this code 
...
" Result.py  "  :- This file Contains the solution file in csv Format .

" Case Information and Problem Statment " :- The problem Stament
